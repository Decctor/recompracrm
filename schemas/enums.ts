...
export const BenefitRedemptionSurfaceEnum = z.enum(["POS", "PONTO_INTERACAO", "LOJA_DIGITAL"]);
export type TBenefitRedemptionSurface = z.infer<typeof BenefitRedemptionSurfaceEnum>;
...
export const ChatMessageContentTypeEnum = z.enum(["TEXTO", "IMAGEM", "VIDEO", "AUDIO", "DOCUMENTO", "FIGURINHA", "LOCALIZACAO"]);
...
export type TAiAgentAttachmentTypeEnum = z.infer<typeof AiAgentAttachmentTypeEnum>;
 ...
 */
export const POSProductOrderingEnum = z.enum(["VALOR_VENDIDO", "QUANTIDADE_VENDIDA", "NOME"], {
...
export const POS_PRODUCT_ORDERING_DEFAULT: TPOSProductOrderingEnum = "VALOR_VENDIDO";

export const POS_PRODUCT_ORDERING_LABELS: Record<TPOSProductOrderingEnum, string> = {
...
export const ImportJobStateEnum = z.enum([
	"AGUARDANDO",
	"EM_ANDAMENTO",
	"PAUSADO_LIMITE",
