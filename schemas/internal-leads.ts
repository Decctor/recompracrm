...
export const InternalLeadStatusCRMEnum = z.enum([
	"NOVO",
	"CONTATO_INICIAL",
	"QUALIFICADO",
	"PROPOSTA",
...
export const InternalLeadOrigemEnum = z.enum([
	"INDICACAO",
	"SITE",
	"COLD_CALL",
	"COLD_EMAIL",
...
export const ActivityRecurrenceSchema = z.object({
	...
	dataFim: z
		.string({ invalid_type_error: "Tipo não válido para a data fim da recorrência." })
		.nullable()
		.default(null),
});
...
export const InternalLeadSchema = z.object({
	...
	posicaoKanban: z
		.number({ invalid_type_error: "Tipo não válido para a posição no kanban." })
		.optional()
		.nullable(),
	...
	probabilidade: z
		.number({ invalid_type_error: "Tipo não válido para a probabilidade." })
		.min(0)
		.max(100)
		.optional()
		.nullable(),
	...
	organizacaoLogoUrl: z
		.string({ invalid_type_error: "Tipo não válido para a logo da organização." })
		.optional()
		.nullable(),
	organizacaoTelefone: z
		.string({ invalid_type_error: "Tipo não válido para o telefone da organização." })
		.optional()
		.nullable(),
	organizacaoEmail: z
		.string({ invalid_type_error: "Tipo não válido para o email da organização." })
		.optional()
		.nullable(),
	organizacaoSite: z
		.string({ invalid_type_error: "Tipo não válido para o site da organização." })
		.optional()
		.nullable(),
	...
	contatoTelefone: z
		.string({ invalid_type_error: "Tipo não válido para o telefone do contato." })
		.optional()
		.nullable(),
	contatoCargo: z
		.string({ invalid_type_error: "Tipo não válido para o cargo do contato." })
		.optional()
		.nullable(),
	contatoUsuarioId: z
		.string({ invalid_type_error: "Tipo não válido para o ID do usuário do contato." })
		.optional()
		.nullable(),

	// Assignment
	responsavelId: z
		.string({ invalid_type_error: "Tipo não válido para o ID do responsável." })
		.optional()
		.nullable(),
});
...
export const InternalLeadActivitySchema = z.object({
	...
	duracaoMinutos: z
		.number({ invalid_type_error: "Tipo não válido para a duração em minutos." })
		.optional()
		.nullable(),
	recorrencia: ActivityRecurrenceSchema.optional().nullable(),
	templateId: z
		.string({ invalid_type_error: "Tipo não válido para o ID do template." })
		.optional()
		.nullable(),
...
export const InternalLeadActivityTemplateSchema = z.object({
	...
	tipo: InternalLeadActivityTipoEnum,
	descricaoPadrao: z
		.string({ invalid_type_error: "Tipo não válido para a descrição padrão." })
		.optional()
		.nullable(),
	duracaoPadraoMinutos: z
		.number({ invalid_type_error: "Tipo não válido para a duração padrão em minutos." })
		.optional()
		.nullable(),
});
