...
export default function KanbanCard({ lead }: KanbanCardProps) {
	...
	return (
		<div
			...
			style={style}
			className={cn(
				"bg-background border rounded-lg p-3 shadow-sm cursor-default",
				...
				<div className="flex-1 min-w-0">
					...
					{lead.valor != null && (
						<div className="mt-2 text-sm font-semibold text-emerald-600">
							{formatToMoney(lead.valor)}
						</div>
					)}
					{lead.responsavel && (
						<div className="mt-1.5 text-xs text-muted-foreground bg-muted rounded px-1.5 py-0.5 w-fit">
