...
function SignUpPage() {
	const [actionResult, actionMethod] = useActionState(signUpWithEmail, {});
							...
							>
								<FieldGroup>
									<div className="flex flex-col items-center gap-2 text-center mb-4">
										...
										<p className="text-sm text-muted-foreground">Preencha suas informações para criar uma conta RecompraCRM</p>
									</div>
									<Field>
										<FieldLabel htmlFor="nome">Nome</FieldLabel>
										<Input id="nome" name="nome" type="text" placeholder="João da Silva" required />
									</Field>
									<Field>
									...
									<FieldDescription className="text-center">
										Já possui uma conta? <a href="/auth/signin">Acesse por aqui</a>
									</FieldDescription>
								</FieldGroup>
							</form>
						</CardContent>
