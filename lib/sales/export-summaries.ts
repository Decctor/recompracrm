...
import type { TFiscalDocumentLifecycleStatusEnum, TFiscalDocumentTypeEnum } from "@/schemas/enums";
...
export function buildSalePaymentsSummary(grupos: TSalePaymentGroup[], maxLength = MAX_SUMMARY_LENGTH): string {
	...
	return joinWithinLimit(parts, maxLength, { singular: "pagamento", plural: "pagamentos" });
}
